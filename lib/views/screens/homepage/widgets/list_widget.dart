...
import '../../repository_details/repository_details_screen.dart';
            ...
            child: ListView(
              ...
              children: dataC.repositorySearchedList
                  .map((element) => GestureDetector(
                        onTap: () {
                          dataC.selectedRepository.value = element;
                          Get.to(() => RepositoryDetailsScreen(), transition: Transition.fadeIn);
                        },
                        child: Card(
                          elevation: 2,
                          child: ListTile(
